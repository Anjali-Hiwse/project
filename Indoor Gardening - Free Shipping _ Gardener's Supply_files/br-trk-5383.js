...
var z="http://p.brsrvr.com/pix.gif";var J="https://p.brsrvr.com/pix.gif";var E="_br_uid_2";var T=E+"_d";
...
window.BrTrk={scriptVersion:"13.0",acctId:5383,defer_mode:null,options:{extraCookies:[],linkTrackingIds:["br-more-results-widget","br-related-searches-widget"],timeTracking:false,pageViewDefinitions:[],pageViewEvents:[{event_name:"global",triggers:[{on_event:"TRIGGER_ON_DOCUMENT_READY",on_event_args:["","0"]}]},{event_name:"conversion",triggers:[],mapping:[{output_var:"basket",mapping_rule:function(j){var i={};
i.v=true;i.r=function(){try{var k=window.BrTrk.getTracker().getBrData()["basket"];var o={};var n={};n.items=[];
var l=0;o.basket=n;o.basket_value=l;return o}catch(m){return h}}();if(i.r!==h){return i.r}return h}}]}],pageViewLookup:{},pageViewHandlers:{},userInteractionEvents:[{event_name:"add_to_cart",triggers:[{on_event:"TRIGGER_ON_GOOGLE_DATALAYER_UPDATE",on_event_args:["event","addToCart","0"]}],mapping:[{output_var:"prod_id",mapping_rule:function(k){var j={};
j.v=true;j.gdl=window.BrTrk.BrUtils.getGoogleDataLayer();j.i=j.gdl.length;while(j.i--){try{j.r=j.gdl[j.i].ecommerce.add.products[0].id;
if(j.r){break}}catch(i){j.r=h;continue}}if(j.r!==h){return j.r}return h}},{output_var:"sku",mapping_rule:function(k){var j={};
j.v=true;j.gdl=window.BrTrk.BrUtils.getGoogleDataLayer();j.i=j.gdl.length;while(j.i--){try{j.r=j.gdl[j.i].ecommerce.add.products[0].variant;
if(j.r){break}}catch(i){j.r=h;continue}}if(j.r!==h){return j.r}return h}}]}],userInteractionLookup:{},userInteractionHandlers:{},brDataObject:"br_data",watchesFormInputPreviousValue:[]},getTracker:function(i,j){if(!c){c=new g(j)
